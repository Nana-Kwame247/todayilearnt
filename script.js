...
async function loadFacts() {
  const res = await fetch(
    "https://fftqwfdhkftxbyzwncyj.supabase.co/rest/v1/Fact?",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZmdHF3ZmRoa2Z0eGJ5enduY3lqIiwicm9sZSI6ImFub24iLCJpYXQiOjE2NzE3NTA0NjQsImV4cCI6MTk4NzMyNjQ2NH0.XT00xq5Fve5jConiCrlwmOxVqE2MMJ4lRHDeYEfPx1g",
      },
    }
  );
  // console.log(res);
